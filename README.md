...
Once the `conda-forge` channel has been enabled, `yt-dlp` can be installed with:

```
conda install yt-dlp
```

It is possible to list all of the versions of `yt-dlp` available on your platform with:
